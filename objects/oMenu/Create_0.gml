...
refresh_setting_strings = function() {
	...
	setting[7] = setting_get("gravity_control") == GRAVITY_CONTROL.ROTATIONAL ? "rotational" : "standard"
}

refresh_save_value_strings = function() {
	if (savedata_is_read()) {
