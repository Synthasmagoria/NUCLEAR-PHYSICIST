...
function savedata_struct() constructor {
	...
	weapon = "oGun"
	clear = false
	subgame = SUBGAME.NUCLEAR
}

///@func savedata_struct_seeker()
function savedata_struct_seeker() : savedata_struct() constructor {
	r = "rTest"
	weapon = ""
}

///@func savedata_struct_penis2()
function savedata_struct_penis2() : savedata_struct() constructor {
	r = "rP2Intro01"
}

///@func savedata_struct_nuclear()
function savedata_struct_nuclear() : savedata_struct() constructor {
	r = "rChernobyl01"
	weapon = "oAK47"
	nuked = false
	skin = "Nuclear"
...
function savedata_save() {
	...
	*/
	...
	if room == rBlankLive
		savedata_set_active("r", savedata_get("r"))
